...
from box_listening_suspender.suspender import BoxListeningSuspenderContexManager
from utils.current_state_retreiver import RedisRawCurrentStateRetriever


def create_redis_box_listener_suspender() -> BoxListeningSuspenderContexManager:
    return BoxListeningSuspenderContexManager(
